...
![](E:/Kelas Mahir/KM01/KM01 Header Notebook.png)
...
### Mengakses Dataset
```{r}
df<- read.csv("https://raw.githubusercontent.com/AfifNurraihan/Data_Sains_Kelas_Mahir/main/titanic_modify.csv", sep=';',stringsAsFactors = T)
df[0:5]
```
